        ...
        if (this._config.useWorker) {
            ...
            if (this._config.transferMemory) {
                this.decode = function(parData, parInfo) {
                    ...
                    worker.postMessage(
                        { buf: parData.buffer, offset: parData.byteOffset, length: parData.length, info: parInfo },
                        [parData.buffer],
                ...
                this.decode = function(parData, parInfo) {
                    ...
                    worker.postMessage({ buf: copyU8.buffer, offset: 0, length: parData.length, info: parInfo }, [
                        copyU8.buffer,
                    ]); // Send data to our worker.
                };
            }
...
export default player(Decoder, YUVCanvas);
